...
if __name__ == '__main__':
  ...
  #load the asf and amc file path
  asf_path = './data/01.asf'
  ##asf_path = './data/02.asf'
  ##asf_path = './data/03.asf'
  amc_path1 = './data/01.amc'
  amc_path2 = './data/02.amc'
  amc_path3 = './data/03.amc'

  #creat a list of amc paths
  amclist=[amc_path3,amc_path2,amc_path1]
  #random order of the motions
  np.random.shuffle(amclist)
  #parse asf 
  joints= parse_asf(asf_path)
  #combine the random amc lists
  M = parse_amc(amclist[0])+parse_amc(amclist[1])+parse_amc(amclist[2])
